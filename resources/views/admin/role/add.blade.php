                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('role.store') }}" method="POST"
                                        ...
                                        @csrf
                                         ...
                                         <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> بيانات  المعلم  </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">   اسم المعلم    </label>
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <div class="form-group ml-3">
                                                            <div class="form-check">
                                                              <input class="form-check-input " type="checkbox" name="perm[]" value="{{$name}}" id="invalidCheck2" >
